...
export class CoreAPI {
    private static readonly coreWorker = SingletonWorkerFactory.getWorker('CoreThread');
    private static readonly coreWrapper = SingletonWorkerFactory.getWrapper('CoreThread');
