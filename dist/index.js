...
import {ObjectLoader as $hgUW1$ObjectLoader, BoxHelper as $hgUW1$BoxHelper, Scene as $hgUW1$Scene, WebGLRenderer as $hgUW1$WebGLRenderer, PerspectiveCamera as $hgUW1$PerspectiveCamera, Box3 as $hgUW1$Box3, SphereGeometry as $hgUW1$SphereGeometry, Matrix4 as $hgUW1$Matrix4, Vector3 as $hgUW1$Vector3, BoxGeometry as $hgUW1$BoxGeometry, PlaneGeometry as $hgUW1$PlaneGeometry, Vector4 as $hgUW1$Vector4} from "three";
import {Subject as $hgUW1$Subject} from "rxjs";
import {Math as $hgUW1$Math, Cartesian3 as $hgUW1$Cartesian3, BoundingSphere as $hgUW1$BoundingSphere, Cartesian2 as $hgUW1$Cartesian2} from "cesium";
...
class $1f355be06b059ce1$export$362079230e3f7f0b {
    ...
    setPosition(position, height = 0) {
        height += $fab42eb3dee39b5b$export$d2ca453b913dcdea.randomOffset();
        ...
        return this._coreThread.updatePosition(this.id, {
            matrix: $fab42eb3dee39b5b$export$d2ca453b913dcdea.localWGS84ToMattrix4(threeWGS84, height),
            position: threeWGS84
        });
    }
    async getPosition() {
        const position = await this._coreThread.getWGS84(this.id);
        return $fab42eb3dee39b5b$export$d2ca453b913dcdea.ThreeWGS84ToCesiumWGS84(position);
    }
    dispose() {
...
class $9c4a242349458aaf$export$19321809bd793da0 {
    ...
    async add(object, position) {
        ...
        const obj = new $1f355be06b059ce1$export$362079230e3f7f0b(id);
        const box = this._calcBox3(object);
        object.userData.box3 = box;
        if (position) await obj.setPosition(position, box.y);
        return obj;
    }
    async get(id) {
...
$27c67f197043802e$export$6a7ef315a0d1ef07.Matrix4 = class {
    static fromTranslationQuaternionRotationScale(translation, rotation, scale, result = new $hgUW1$Matrix4()) {
        ...
        // prettier-ignore
        result.set(m00 * scaleX, m10 * scaleX, m20 * scaleX, 0, m01 * scaleY, m11 * scaleY, m21 * scaleY, 0, m02 * scaleZ, m12 * scaleZ, m22 * scaleZ, 0, translation.x, translation.y, translation.z, 1);
        return result;
    }
};
...
class $54db50d775dc5ee6$export$a930246057f569fe extends $hgUW1$Vector3 {
    static get WGS84_RADII_SQUARED() {
        return new $54db50d775dc5ee6$export$a930246057f569fe(40680631590769, 40680631590769, 40408299984661.445);
    }
    static get UINT_X() {
...
class $fab42eb3dee39b5b$export$d2ca453b913dcdea {
    ...
    static localWGS84ToMattrix4(position, height = 0) {
        const matrix = $764ac7478921f02a$export$2e7e2a6179fcdd5c.headingPitchRollToFixedFrame($54db50d775dc5ee6$export$a930246057f569fe.fromDegree(position.longitude, position.latitude, height));
        const localToWgs84Mattrix = new $hgUW1$Matrix4();
        // prettier-ignore
        localToWgs84Mattrix.set(matrix.elements[0], matrix.elements[4], matrix.elements[8], matrix.elements[12], matrix.elements[1], matrix.elements[5], matrix.elements[9], matrix.elements[13], matrix.elements[2], matrix.elements[6], matrix.elements[10], matrix.elements[14], matrix.elements[3], matrix.elements[7], matrix.elements[11], matrix.elements[15]);
        return localToWgs84Mattrix;
    }
    static applyObjectWGS84Postion(geometry, position) {
        let pos;
        if (position instanceof $5876ab33e7eee8c7$export$1156bcd15cdf41b6) pos = this.CesiumWGS84ToThreeWGS84(position);
        else pos = position;
...
class $ec71d95b9270bbe0$export$23d6a54f0bbc85a3 extends $hgUW1$Vector4 {
    static fromAxisAngle(aixs, angle, result) {
        ...
        if (!result) return new $ec71d95b9270bbe0$export$23d6a54f0bbc85a3(x, y, z, w);
...
const $764ac7478921f02a$var$first = 'down';
const $764ac7478921f02a$var$second = 'east';
const $764ac7478921f02a$var$third = $764ac7478921f02a$var$vectorProductLocalFrame[$764ac7478921f02a$var$first][$764ac7478921f02a$var$second];
// prettier-ignore
...
$764ac7478921f02a$var$degeneratePositionLocalFrame[$764ac7478921f02a$var$first];
$764ac7478921f02a$var$degeneratePositionLocalFrame[$764ac7478921f02a$var$second];
$764ac7478921f02a$var$degeneratePositionLocalFrame[$764ac7478921f02a$var$third];
class $764ac7478921f02a$export$2e7e2a6179fcdd5c {
    static localFrameToFixedFrameGenerator(firstAixs, secondAxis) {
        ...
        f = (origin, result = new $hgUW1$Matrix4())=>{
            ...
            if (origin.isZero()) {
                ...
                $1a1da69edc3c7876$export$edfc7dc0e9336c5b.WGS84.geodeticSurfaceNormal(origin, $764ac7478921f02a$var$scratchCalculateCartesian.up);
    ...
    static headingPitchRollToFixedFrame(origin, result = new $hgUW1$Matrix4()) {
        const eastNorthUpToFixedFrame = $764ac7478921f02a$export$2e7e2a6179fcdd5c.localFrameToFixedFrameGenerator('east', 'north');
        const hprQuration = $ec71d95b9270bbe0$export$23d6a54f0bbc85a3.fromHeadingPitchRoll(new $91bc6249ba4a0756$export$129f66e263976997(0, 0, 0));
...
export {$234747a9630b4642$export$3545e07a80636437 as REVISION, $1b983a38f3bf9a9b$export$3c33b7cf4c12f471 as InterfcaeFactory, $eb3eccffcb58f145$export$d3bc06bbab0156ac as EarthGeometry, $fab42eb3dee39b5b$export$d2ca453b913dcdea as Utils, $82e614c8221c81c3$export$689d6f22f19954a7 as makeTeapotGeometry, $82e614c8221c81c3$export$d1c415793f46918c as makeBoxGeometry, $82e614c8221c81c3$export$ef5bbeb4ada3d789 as makePlaneGeometry, $5876ab33e7eee8c7$export$1156bcd15cdf41b6 as CesiumWGS84, $5876ab33e7eee8c7$export$5fca51fe6d1fa856 as ThreeWGS84, $764ac7478921f02a$export$2e7e2a6179fcdd5c as Transforms};
