...
import { Vector3, Matrix4, Object3D, SphereGeometry, PlaneGeometry, BoxGeometry } from "three";
...
declare class HeadingPitchRoll extends Vector3 {
...
export class Transforms {
    ...
    static matrix4ToFixedFrame(origin: Cartesian3, matrix: Matrix4, result?: Matrix4): Matrix4;
    static headingPitchRollToFixedFrame(origin: Cartesian3, headingPitchRoll?: HeadingPitchRoll, result?: Matrix4): Matrix4;
}
...
declare class ObjectAPI {
    ...
    getPosition(): Promise<CesiumWGS84 | undefined>;
